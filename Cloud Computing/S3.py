...
def Results():
        ...
        sigusr=logname[-1]
        print(mail1,sigusr)
        ACCESS_ID='AKIAVIGWAIF5OADCMPF2'
        ACCESS_KEY='EnBqUrJWSHdKcCcCMGzJiPGPLnDEL67N1TQSFrtK'
        # try:
        if request.method=='POST':
                ...
                conn.commit()
                print('Create done !!')
                cursor.execute('INSERT INTO USER(USERNAME,FILENAME,MAIL) VALUES (%s,%s,%s)',(sigusr,fname,mail1))
                conn.commit()
                ...
                payload={'email':End,"arn":"arn:aws:sns:us-east-1:361226060154:VsCode_test","URL":url}
                lambdaclient.invoke(
                                FunctionName='Sample',
